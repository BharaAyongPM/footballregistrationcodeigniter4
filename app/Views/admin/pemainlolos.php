...
<div class="card-body">
    ...
    <tr>
        ...
        <?php endif; ?><a href="<?php echo base_url('admin/lolos/editktplolos/'.$pemain['id']) ?>" class="btn btn btn-primary">Lihat KTP</a</td>
        </tr>
        <tr>
            <td>Surat Rekomendasi Club</td>
            <td><?= $pemain['surat_rekomendasi'] ?> &nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/lolos/suratlolos/'.$pemain['id']) ?>" class="btn btn btn-primary">Lihat</a></td>
</tr>
<td>Foto </td>
<td><?php if ($pemain['foto']) : ?>
        ...
        <?php endif; ?> <a href="<?php echo base_url('admin/lolos/editfotololos/'.$pemain['id']) ?>" class="btn btn btn-primary">LihatFoto</a></td>
        
<tr> 
    <td><a href="<?php echo base_url('admin/lolos/editlolos/'.$pemain['id']) ?>" class="btn btn btn-primary">Edit</a> </td>
    <td><form method="post" action="admin/lolos/deletelolos/<?php echo $pemain['id']; ?>">
