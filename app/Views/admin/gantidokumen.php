...
<form method="post" enctype="multipart/form-data" action="<?= base_url('admin/pemain/gantipdf/'.$pemain['id']) ?>">
<?= $pemain['surat_rekomendasi'] ?>
        ...
        <a href="<?= site_url('/admin/pemain/downloadsurat/' . $pemain['id']) ?>"class="btn btn-primary">Download Surat</a>
