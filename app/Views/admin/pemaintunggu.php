...
<div class="card-body">
        ...
        <td><a href="<?php echo base_url('admin/tunggu/loloskan/'.$pemain['id']) ?>" class="btn btn btn-primary">LOLOS</a> </td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?= base_url('admin/dbadmin/tunggu') ?>" class="btn btn-secondary">Kembali</a>
