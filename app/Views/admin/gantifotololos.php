...
<form method="post" enctype="multipart/form-data" action="<?= base_url('admin/lolos/gantifotololos/'.$pemain['id']) ?>">
<<?php if ($pemain['foto']) : ?>
        ...
        <a href="<?= site_url('/admin/lolos/downloadfotololos/' . $pemain['id']) ?>"class="btn btn-primary">Download Foto</a>
