...
<section id="about" class="about ">
  ...
  <h1 class="mt-1"> Daftar Peserta dan Tim  <span style="color:red;"> Jakarta Select </span></h1>
...
<td><?= $value['team'] ?></td>
                ...
                <td><img src="<?= base_url('uploads/' . $value['foto']) ?>"style="width:100%;max-width:100px" alt="<?= $value['foto'] ?>"></td>
